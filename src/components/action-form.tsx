...
export function ActionForm({
 ...
 const responsibleOptions = useMemo(() => {
    ...
    // Create a context object for pattern evaluation
    const context = {
        action: { 
            creator: user, 
    ...
    actionType.possibleAnalysisRoles.forEach(roleId => {
        ...
        if (role) {
            const resolvedEmails = evaluatePattern(role, context);
...
}, [selectedActionTypeId, selectedCenterId, selectedAffectedAreasIds, selectedAffectedCentersIds, masterData, user, initialData, mode]);
