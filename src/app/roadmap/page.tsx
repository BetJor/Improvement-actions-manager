    ...
    const timeline = [
        {
          ...
          completed_tasks: [
            ...
            "Estructurar la aplicación con el directorio App y i18n.",
        ...
        },
        {
          ...
          duration: "Continuo",
          completed_tasks: [
            "Solucionar errores de traducción (`MISSING_MESSAGE`) para una experiencia multilingüe robusta.",
        ...
        <div className="flex flex-col gap-6">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Las grandes metas de desarrollo que ya se han alcanzado y las que quedan pendientes.</CardDescription>
                </CardHeader>
